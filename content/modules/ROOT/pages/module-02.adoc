...
----
cd $HOME/modernize-ocp-virt-workspace/lab-3
----
...
NOTE: For details of how this is done see the scripts at {modernize_ocp_virt_repo}/blob/main/lab-3/add-envoy-to-travel-agency-services-domain.sh[add-envoy-to-travel-agency-services-domain.sh, window=_blank], {modernize_ocp_virt_repo}/blob/main/lab-3/add-envoy-to-travel-portal-domain.sh[add-envoy-to-travel-portal-domain.sh, window=_blank], {modernize_ocp_virt_repo}/blob/main/lab-3/add-envoy-to-travel-control.sh[add-envoy-to-travel-control.sh, window=_blank]. 
