# Module 2: Integrating and Observing Virtual Machines in OpenShift Service Mesh
...
NOTE: All assets for this module are in the folder `module-02`. Please change the directory into this folder.
