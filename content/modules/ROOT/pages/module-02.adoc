...
Returning to `Service Mesh -> Traffic Graph` you should see that connectivity has been restored between the *{modernize_ocp_virt_username}-travel-portal* and *{modernize_ocp_virt_username}-travel-agency* projects.

image::summit/223-traffic-restored.png["Traffic graph showing restored connectivity after applying selective authorization policies", link=self, window=blank,width=100%]
