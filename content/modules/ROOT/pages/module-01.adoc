...
IMPORTANT: Prior to moving on to the next section, to conserve resources and ensure a smoot lab experience, make sure that any of the VMs created in the *{user}-vms* project as a part of this module are shut down, and/or deleted. We will not be making use of them again.
