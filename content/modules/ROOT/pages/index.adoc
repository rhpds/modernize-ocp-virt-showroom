...
This is lab *LB8685: Accelerating Infrastructure Modernization with OpenShift Virtualization*

In this lab you will be using OpenShift as regular user scoped to projects that you own.
...
NOTE: Demonstrating that virtual machines can be deployed and simply run in OpenShift is not the end, it is the beginning of the cloud-native journey.
...
image::02-travels-dashboard.png[link="self", window=blank, width=100%]
