...
https://{modernize_ocp_virt_username}-ingress-istio-gateway.{modernize_ocp_virt_apps_domain}
...
IMPORTANT: You will need to perform these two tasks fairly quickly, or the VM may automatically restart due to Argo CD protecting the VM's desired running state.
