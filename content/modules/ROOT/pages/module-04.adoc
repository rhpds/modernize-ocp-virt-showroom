...
* Understand the role of Red Hat Developer Hub as an internal developer portal for simplifying development
* Explore how software templates enable self-service VM provisioning on OpenShift
* Experience an interactive demonstration of VM provisioning through Developer Hub
